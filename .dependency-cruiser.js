...
module.exports = {
  forbidden: [
    // custom one
    {
      "name": "Not from client to any",
      "comment": "Do not allow imports to other modules from client module",
      "severity": "error",
      "from": { "path": "./modules/client/" },
      "to": { "path": "./modules/(?!client).*" }
    },
...
// generated: dependency-cruiser@11.3.1 on 2022-02-22T18:54:32.095Z
